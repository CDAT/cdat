...
action['autogen.sh'] = "autogen.sh ; ./configure --prefix=%s  --with-python=%s ; make ; make install ;" % (os.environ.get("EXTERNALS",os.path.join(sys.prefix,'Externals')), os.path.join(sys.exec_prefix,'bin','python'))
