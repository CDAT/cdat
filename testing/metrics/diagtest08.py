...
imagethreshold = None
ncfiles = {}
ncfiles['dv_T_ZonalMean_model_ANN_ft1_cam_output_ANN.nc'] = ['dv_T_ZonalMean model_ANN_ft1_cam_output']
ncfiles['dv_T_ZonalMean_obs_ANN_ft2_obs_atmos_NCEP_ANN.nc'] = ['dv_T_ZonalMean obs_ANN_ft2_obs_atmos_NCEP']
