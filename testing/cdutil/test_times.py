...
f   = cdms2.open(os.path.join(vcs.sample_data,'tas_mo.nc'))
fsc = cdms2.open(os.path.join(vcs.sample_data,'tas_mo_clim.nc'))
...
f = cdms2.open(os.path.join(vcs.sample_data,'tas_6h.nc'))
