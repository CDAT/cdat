# Test the use of hatches for isofill plots
...
isof = x.createisofill('test_isofill_hatches')
...
isof.fillareaopacity = [50, 75, 20, 100, 25, 30, 40, 80, 60, 100]
...
testImage = os.path.abspath("test_isofill_hatches.png")
x.png(testImage)
