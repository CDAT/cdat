...
if(CMAKE_OSX_DEPLOYMENT_TARGET AND CMAKE_OSX_SYSROOT)
  string(REGEX REPLACE ".*MacOSX([0-9]+\\.[0-9]+).*" "\\1"
    _CURRENT_SDK_VERSION "${CMAKE_OSX_SYSROOT}")
  if(${CMAKE_OSX_DEPLOYMENT_TARGET} VERSION_GREATER ${_CURRENT_SDK_VERSION})
    message(AUTHOR_WARNING
      "Deployment target (${CMAKE_OSX_DEPLOYMENT_TARGET}) cannot be greater "
      "than the SYSROOT version (${_CURRENT_SDK_VERSION}) as specified by "
      "CMAKE_OSX_SYSROOT. "
      "Reverting CMAKE_OSX_DEPLOYMENT_TARGET to SYSROOT version.")
    set(CMAKE_OSX_DEPLOYMENT_TARGET ${_CURRENT_SDK_VERSION})
  endif()
endif()
