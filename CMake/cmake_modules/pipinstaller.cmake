...
ExternalProject_Add(${nm}
  ...
  CONFIGURE_COMMAND ""
  BUILD_COMMAND ""
  INSTALL_COMMAND env LD_LIBRARY_PATH=$ENV{LD_LIBRARY_PATH} CFLAGS=$ENV{CFLAGS} LDFLAGS=$ENV{LDFLAGS} PKG_CONFIG_PATH=$ENV{PKG_CONFIG_PATH} PYTHONPATH=${PYTHONPATH} ${USR_ENVS} ${PYTHON_EXECUTABLE} setup.py ${USER_BUILD_EXT_OPTS} install ${OLDSTR} ${USER_INSTALL_OPTIONS} ${PRFX}
  DEPENDS ${${nm}_deps}
  ${ep_log_options}
)
