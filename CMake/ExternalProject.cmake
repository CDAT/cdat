...
if(result)
  ...
  foreach(arg IN LISTS command)
    set(msg \"\${msg} '\${arg}'\")
  endforeach(arg)
  set(msg \"\${msg}\\n From ${logbase}-out.log\\n\")
  set(msg \"\${msg}-------------------------------------------------\n\")
  if (EXISTS ${logbase}-out.log)
    file(READ ${logbase}-out.log OUTFILE LIMIT 10000)
  else()
    set(OUTFILE \"${logbase}-out.log is missing\\n\")
  endif()
  set(msg \"\${msg}\${OUTFILE}\")
  set(msg \"\${msg}-------------------------------------------------\\n\")
  set(msg \"\${msg} From ${logbase}-err.log\\n\")
  set(msg \"\${msg}-------------------------------------------------\\n\")
  if (EXISTS ${logbase}-err.log)
    file(READ ${logbase}-err.log OUTFILE LIMIT 10000)
  else()
    set(OUTFILE \"${logbase}-err.log is missing\\n\")
  endif()
  set(msg \"\${msg}\${OUTFILE}\")
  set(msg \"\${msg}-------------------------------------------------\\n\")
  message(FATAL_ERROR \"\${msg}\")
