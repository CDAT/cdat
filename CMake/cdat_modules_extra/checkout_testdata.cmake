...
# 9) If the remote branch exists, or we are using master, run
#    'git pull origin <branch>:<branch>' to fetch/update the local branch from
#    the remote.
# 10) Check out the local <branch> in TESTDATA_DIR repo.
#
...
string(FIND "${OUTPUT}" " remote/origin/${BRANCH}\n" POS)
if(NOT POS EQUAL -1)
...
# 10) Check out the desired branch in TESTDATA_DIR repo.
