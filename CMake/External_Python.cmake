...
if(APPLE)
  ...
  set(PYTHON_LIBRARY ${CMAKE_INSTALL_PREFIX}/Python.framework/Versions/${PYVER}/Python)
  ...
  set(PYTHON_SITE_PACKAGES ${CMAKE_INSTALL_PREFIX}/Python.framework/Versions/${PYVER}/lib/python${PYVER}/site-packages)
else()
