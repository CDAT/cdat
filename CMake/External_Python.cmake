...
if(APPLE)
  ...
  set(PYTHON_INCLUDE ${cdat_EXTERNALS}/include/python${PYTHON_MAJOR_SRC}.${PYTHON_MINOR_SRC})
  set(PYTHON_LIBRARY ${cdat_EXTERNALS}/lib/libpython${PYTHON_MAJOR_SRC}.${PYTHON_MINOR_SRC}.so)
  set(PYTHON_LIBRARY_DIR ${cdat_EXTERNALS}/lib)
  set(PYTHON_EXECUTABLE ${cdat_EXTERNALS}/bin/python)
endif()
