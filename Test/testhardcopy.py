...
def test():
    ...
    # create template 'test' from AMIPDUD
    t1 = x.createtemplate('test1', 'ASD1_of_2')
    # create template 'test' from AMIPDUD
    t2 = x.createtemplate('test2', 'ASD2_of_2')
    # create isofill graphics method from default
    isof = x.createisofill('test')
    # create isoline graphics method from default
    isol = x.createisoline('test')
