...
class CdmsTestSetup(TestSetup):
    def __init__(self, uvcdat_setup, repo_name, py_version, branch='master', label='master'):
        ...
        print("xxx esgf_pwd: {p}, esgf_user: {u}".format(p=esgf_pwd, u=esgf_user))
        ...
        cmd = "echo {p} | myproxyclient logon -s esgf-node.llnl.gov -p 7512 -t 12 -S -b -l {u} -o {w}/.esg/esgf.cert".format(p=esgf_pwd,
                                                                                                                             u=esgf_user,
                                                                                                                             w=workdir)
        ret_code = run_in_conda_env(conda_path, env, cmds_list)
        ...
        #dds_url = "https://esgf-node.cmcc.it/thredds/dodsC/esg_dataroot/cm\
ip5/output1/CMCC/CMCC-CM/decadal2005/mon/atmos/Amon/r1i1p1/v20170725/cct/cct_Amon_CMCC-CM_decadal2005_r1i1p1_202601-20351\
2.nc.dds"
