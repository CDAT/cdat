...
f = cdms.open(os.path.join(sys.prefix,'sample_data','sampleCurveGrid4.nc'))
...
f = cdms.open(os.path.join(sys.prefix,'sample_data','cdtest13.xml'))
...
g = cdms.open(os.path.join(sys.prefix,'sample_data','u_2000.nc'))
samp = g('u')
