...
class WKPlot(object):
    ...
    def __init__(self, x=None, datawc_x1=-15, datawc_x2=15,
                 datawc_y1=0, datawc_y2=.8, min=-1.4,
                 max=2., delta_isofill=.2, delta_isoline=.1,
                 days_lines=(30, 6, 3, 2,), H=[12., 25., 50.]):
        """
    ...
    def plot_figure2(self, bg_power, bg=0, x=None, min=-1.4, max=2.,
                     delta_isofill=None, delta_isoline=.1,
                     days_lines=(30, 6, 3, 2,)):
        displays = []  # store displays used
        ...
        x.portrait()
        tmpl, tmplnoleg, isof, isol1, isol2 = graphics.createTemplateandGM(
            x, min, max, delta_isofill, delta_isoline, days_lines,
    ...
    def plot_figure3(self, S, A, bg=0, x=None, min=None, max=None,
        ...
        for h in H:
            ...
            t.x = [xx]
            t.y = [
                float(IG2(planetaryzonalwavenumber=(xx, xx, 'ccb'),
                          squeeze=1))]
            displays.append(x.plot(t, bg=bg))
            if h == H[2]:
                xx = 5
            ...
            if h == H[0]:
                ...
                t.x = [xx]
                t.y = [
                    float(KW(planetaryzonalwavenumber=(xx, xx, 'ccb'),
                             squeeze=1))]
                t.string = ['  MJO']
                displays.append(x.plot(t, bg=bg))
                xx = 7
            ...
            if h == H[1]:
                ...
                t.x = [xx]
                t.y = [
                    float(IG(planetaryzonalwavenumber=(xx, xx, 'ccb'),
                             squeeze=1))]
                t.string = ['n=1 WIG']
                displays.append(x.plot(t, bg=bg))
                xx = 6
