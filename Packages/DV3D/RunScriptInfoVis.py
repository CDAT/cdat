...
g.init(init=(grid_file, data_file, interface, varnames, grid_coords, var_proc_op, roi, 'xyz'),
       n_overview_points=n_overview_points, n_cores=ncores, blocking=True)  # , plot_type = PlotType.List  )

rw = g.getRenderWindow()
print "Got render window"
sys.stdout.flush()
