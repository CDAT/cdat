...
#         self.updateModule()
    ...
    def activateEvent(self, caller, event):
        ...
        if self.clipper and (self.cropRegion is None):
    ...
    def toggleClipping(self, enableClipping):
        ...
        if self.clipping_enabled and self.isInSelectedCell:
            self.clipOn()
        else:
            self.clipOff()
...
# if i % 50 == 0:  print "   --- ctf[%d:%d:%d] --  %.2e: ( %.2f %.2f %.2f
# ) " % ( i, lut_index, self.invert, data_value, color[0], color[1],
# color[2] )
