...
#1        print " CommandeerSlider[%d]: ('%s') %s: %s in %s " % ( index, label, self.InteractionState, str(tvals), str(bounds) )
...
#1            print " ---> UpdateInteractionState: %s " % str(self.InteractionState)                  
            if button_state: 
