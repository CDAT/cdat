...
npoints=50
X=numpy.ma.arrayrange(npoints,dtype=numpy.float)
...
# dx for the sin
YY1=numpy.ma.zeros((2,npoints),dtype=numpy.float)
YY1[0]=Y1
YY1[1]=Y1*.1
...
# dy for the cos
YY2=numpy.ma.zeros((2,npoints),dtype=numpy.float)
YY2[0]=Y2
YY2[1]=Y2*.1
...
YY3=numpy.ma.zeros((3,npoints),dtype=numpy.float)
YY3[0]=Y3
YY3[1]=Y3*.1
YY3[2]=Y3*.1
...
x.ps(TEMPDIR+'xmgrace_demo_numpy') # postscript
x.ps(TEMPDIR+'xmgrace_demo_numpy_gray',color='grayscale') # grayscale postscript
x.jpeg(TEMPDIR+'xmgrace_demo_numpy',dpi=300,quality=80) # jpeg 300dpi, 80% quality compression
x.pdf(TEMPDIR+'xmgrace_demo_numpy')
x.eps(TEMPDIR+'xmgrace_demo_numpy')
x.svg(TEMPDIR+'xmgrace_demo_numpy')
x.mif(TEMPDIR+'xmgrace_demo_numpy')
x.pnm(TEMPDIR+'xmgrace_demo_numpy')
x.png(TEMPDIR+'xmgrace_demo_numpy')
x.metafile(TEMPDIR+'xmgrace_demo_numpy')
