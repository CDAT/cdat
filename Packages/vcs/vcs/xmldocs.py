...
obj_scriptdoc = """
    Saves out a %s object in JSON, or Python format to a designated file.
...
"""
sm_scriptdoc = """
    Saves out a copy of the %s secondary method in JSON, or Python format to a designated file.
...
colormap_script = gm_scriptdoc % (('colormap',) * 5)
boxfill_script = gm_scriptdoc % (('boxfill',) * 5)
isoline_script = gm_scriptdoc % (('isoline',) * 5)
isofill_script = gm_scriptdoc % (('isofill',) * 5)
yxvsx_script = gm_scriptdoc % (('yxvsx',) * 5)
meshfill_script = gm_scriptdoc % (('meshfill',) * 5)
fillarea_script = gm_scriptdoc % (('fillarea',) * 5)
marker_script = gm_scriptdoc % (('marker',) * 5)
line_script = gm_scriptdoc % (('line',) * 5)

# Object scriptdocs
template_script = obj_scriptdoc % (('template',) * 5)

# Secondary Method scriptdocs
projection_script = sm_scriptdoc % (('projection',) * 5)
