...
"""
    ...
    def __init__(
            self, parent, Gcon_name=None, Gcon_name_src='default', createGcon=0):
        #                                                           #
        #############################################################
        ...
        self.__doc__ = self.__doc__ % (
            xmldocs.graphics_method_core_notime, xmldocs.linedoc)
##         #                                                         #
##         ###########################################################
