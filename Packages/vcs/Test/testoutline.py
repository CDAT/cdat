...
def test():
    ...
    x.clear()                            # clear the VCS Canvas
    # plot outline using 'default' template
    x.outline(s, a, 'default', bg=bg)
    support.check_plot(x)
    ...
    x.clear()				# clear the VCS Canvas
    # plot outline template 't', outline 'a', and array 's'
    x.plot(t, a, s, bg=bg)
    support.check_plot(x)
    x.clear()				# clear the VCS Canvas
    # plot using outline 'a', array 's', and template 't'
    x.outline(a, s, t, bg=bg)
    support.check_plot(x)
