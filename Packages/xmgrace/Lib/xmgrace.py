...
## Third Party
## See end of file
## Thanks to: Michael Haggerty <mhagger@blizzard.harvard.edu>
## for the original piping capability
...
##    Graph class changed, xmin,xmax,ymin,ymax still exist
##        but it is better to set  Graph.xaxis.min,...,Graph.yaxis.max
##    added the x.update()
## version 1.1.3b
## October 9th, 2000:
## tick marks (x)axis.tick.spec.values can now be a dictionnary,
## no need to fill .loc and .values
## x.orientation(),x.portrait(),x.landscape() added
## January 18th, 2001
## tick marks (x)axis.tick.spec.loc can now be a
## dictionnary as well, no need to fill .loc and .values
## January 22nd, 2001
...
## version 1.2
## remove dependency to PropertiedClasses from
## Numeric instead gets it from object
## Validation Functions andslots are still available
## but now in 'standard' python
...
class COLOR(object):
    ...
    def __init__(self, name='Black', rgb=None, id=16):
        ...
        if id < 16:
            raise ValueError(
                'Color id less than 16 are predefined and cannot be reset !')
        self.id = id
    ...
    def __conv_color(self, col):
        ...
        if ret is [None, None, None] or ret == [None, None, None]:
            ret = [0, 0, 0]
        return ret
...
class REGION(object):
    ...
    def _setlinestyle(self, value):
        self._linestyle = ValidationFunctions.checkLinestyle(
    ...
    def _setlinewidth(self, value):
        self._linewidth = ValidationFunctions.checkPositiveNumber(
...
class GRAPH(object):
    ...
    def __init__(self, parent, ymin=0., ymax=1., xmin=0., xmax=1.):
        ...
        class Fixedpoint(object):
            ...
            def _setstatus(self, value):
                self._status = ValidationFunctions.checkOnOff(
                    self, 'status', value)
            status = property(_getstatus, _setstatus)
            ...
            def _setprec(self, value):
                self._prec = ValidationFunctions.checkPositiveInt(
                    self, 'prec', value)
            ...
            def _setformat(self, value):
                self._format = ValidationFunctions.checkFormat(
                    self, 'format', value)
        ...
        class Title(object):
            ...
            def _setsize(self, value):
                self._size = ValidationFunctions.checkPositiveNumber(
                    self, 'size', value)
            ...
            def _setcolor(self, value):
                self._color = ValidationFunctions.checkColor(
                    self, 'color', value)
            color = property(_getcolor, _setcolor)
        ...
        class Axe(object):
            ...
            def __init__(self, parent, graph):
                ...
                class Bar(object):
                    ...
                    def _setlinestyle(self, value):
                        self._linestyle = ValidationFunctions.\
                            checkLinestyle(self, 'linestyle', value)
                    linestyle = property(_getlinestyle, _setlinestyle)
                    ...
                    def _setlinewidth(self, value):
                        self._linewidth = ValidationFunctions.\
                            checkPositiveNumber(self, 'linewidth', value)
                    linewidth = property(_getlinewidth, _setlinewidth)
                ...
                class Label(object):
                    ...
                    def __init__(self, parent):
                        ...
                        class Place(object):
                            ...
                            def _setloc(self, value):
                                self._loc = ValidationFunctions.checkLoc(
                                    self, 'loc', value)
                            ...
                            def _setside(self, value):
                                self._side = ValidationFunctions.checkSide(
                                    self, 'side', value)
                    ...
                    def _setlayout(self, value):
                        self._layout = ValidationFunctions.checkLayout(
                            self, 'layout', value)
                    ...
                    def _setchar_size(self, value):
                        self._char_size = ValidationFunctions.\
                            checkPositiveNumber(self, 'char_size', value)
                    ...
                    def _setfont(self, value):
                        self._font = ValidationFunctions.checkFont(
                            self, 'font', value)
                    font = property(_getfont, _setfont)
                ...
                class Tick(object):
                    ...
                    def __init__(self, parent):
                        ...
                        class Spec(object):
                            ...
                            def _setloc(self, value):
                                ValidationFunctions.checkTickLocation(
                                    self, 'loc', value)
                            loc = property(_getloc, _setloc)
                            ...
                            def _setvalues(self, value):
                                ValidationFunctions.checkTickValues(
                                    self, 'values', value)
                            ...
                            def _settype(self, value):
                                self._type = ValidationFunctions.checkTickType(
                                    self, 'type', value)
                            type = property(_gettype, _settype)
                        ...
                        class STick(object):
                            ...
                            def _setcolor(self, value):
                                self._color = ValidationFunctions.\
                                    checkColor(self, 'color', value)
                            color = property(_getcolor, _setcolor)
                            ...
                            def _setsize(self, value):
                                self._size = ValidationFunctions.\
                                    checkPositiveNumber(self, 'size', value)
                            size = property(_getsize, _setsize)
                            ...
                            def _setgrid(self, value):
                                self._grid = ValidationFunctions.checkOnOff(
                                    self, 'grid', value)
                        ...
                        class Tlbl(object):
                            ...
                            def _setprec(self, value):
                                self._prec = ValidationFunctions.\
                                    checkPositiveInt(
                                        self, 'prec', value)
                            prec = property(_getprec, _setprec)
                            ...
                            def _setskip(self, value):
                                self._skip = ValidationFunctions.\
                                    checkPositiveInt(
                                        self, 'skip', value)
                            ...
                            def _setstagger(self, value):
                                self._stagger = ValidationFunctions.\
                                    checkPositiveInt(
                                        self, 'stagger', value)
                            ...
                            def _setappend(self, value):
                                self._append = ValidationFunctions.checkString(
                                    self, 'append', value)
                            ...
                            def _setprepend(self, value):
                                self._prepend = ValidationFunctions.\
                                    checkString(
                                        self, 'prepend', value)
                            ...
                            def _setangle(self, value):
                                self._angle = ValidationFunctions.checkAngle(
                                    self, 'angle', value)
                            ...
                            def _setplace(self, value):
                                self._place = ValidationFunctions.checkSide(
                                    self, 'place', value)
                            ...
                            def _setoffset(self, value):
                                self._offset = ValidationFunctions.checkLoc(
                                    self, 'offset', value)
                            ...
                            def _setstart(self, value):
                                self._start = ValidationFunctions.checkAuto(
                                    self, 'start', value)
                            ...
                            def _setstop(self, value):
                                self._stop = ValidationFunctions.checkAuto(
                                    self, 'stop', value)
                    ...
                    def _settype(self, value):
                        self._type = ValidationFunctions.checkTicksType(
                            self, 'type', value)
                    type = property(_gettype, _settype)
                    ...
                    def _setinc(self, value):
                        self._inc = ValidationFunctions.checkPositiveNumber(
                            self, 'inc', value)
                    ...
                    def _setnsub(self, value):
                        self._nsub = ValidationFunctions.checkPositiveInt(
                            self, 'nsub', value)
                    ...
                    def _setminor_ticks(self, value):
                        self._minor_ticks = ValidationFunctions.\
                            checkPositiveInt(
                    ...
                    def _setplace_rounded(self, value):
                        self._place_rounded = ValidationFunctions.\
                            checkTrueFalse(
                                self, 'place_rounded', value)
                    place_rounded = property(
                        _getplace_rounded, _setplace_rounded)

                    def _getorientation(self):
                        return self._orientation

                    def _setorientation(self, value):
                        self._orientation = ValidationFunctions.checkInOut(
            ...
            def _setscale(self, value):
                self._scale = ValidationFunctions.checkScale(
                    self, 'scale', value)
            ...
            def _setinvert(self, value):
                self._invert = ValidationFunctions.checkOnOff(
                    self, 'invert', value)
            ...
            def _setzero(self, value):
                self._zero = ValidationFunctions.checkTrueFalse(
                    self, 'zero', value)
            ...
            def _setxoffset(self, value):
                self._xoffset = ValidationFunctions.checkNumber(
                    self, 'xoffset', value)
            ...
            def _setyoffset(self, value):
                self._yoffset = ValidationFunctions.checkNumber(
                    self, 'yoffset', value)
            ...
            def _setmin(self, value):
                self._min = ValidationFunctions.setAxesMinMax(
                    self, 'min', value)
            ...
            def _setmax(self, value):
                self._max = ValidationFunctions.setAxesMinMax(
                    self, 'max', value)
            ...
            def _setlabel(self, value):
                self._label = ValidationFunctions.checkString(
                    self, 'label', value)
        ...
        class Legend(object):
            ...
            def __init__(self, parent):
                ...
                class Box(object):
                    ...
                    def _setpattern(self, value):
                        self._pattern = ValidationFunctions.checkPattern(
                            self, 'pattern', value)
                    ...
                    def _setfcolor(self, value):
                        self._fcolor = ValidationFunctions.checkColor(
                            self, 'fcolor', value)
                    ...
                    def _setfpattern(self, value):
                        self._fpattern = ValidationFunctions.checkPattern(
                            self, 'fpattern', value)
            ...
            def _setloctype(self, value):
                self._loctype = ValidationFunctions.checkLoctype(
                    self, 'loctype', value)
            ...
            def _setchar_size(self, value):
                self._char_size = ValidationFunctions.checkPositiveNumber(
            ...
            def _setlength(self, value):
                self._length = ValidationFunctions.checkPositiveInt(
                    self, 'length', value)
            ...
            def _setvgap(self, value):
                self._vgap = ValidationFunctions.checkPositiveInt(
                    self, 'vgap', value)
            ...
            def _sethgap(self, value):
                self._hgap = ValidationFunctions.checkPositiveInt(
                    self, 'hgap', value)
            ...
            def _setinvert(self, value):
                self._invert = ValidationFunctions.checkTrueFalse(
                    self, 'invert', value)
            invert = property(_getinvert, _setinvert)
        ...
        class Frame(object):
            ...
            def _settype(self, value):
                self._type = ValidationFunctions.checkFrameType(
                    self, 'type', value)
            type = property(_gettype, _settype)
            ...
            def _setbackground_color(self, value):
                self._background_color = ValidationFunctions.checkColor(
                    self, 'background_color', value)
            background_color = property(
                _getbackground_color, _setbackground_color)

            def _getbackground_pattern(self):
                return self._background_pattern

            def _setbackground_pattern(self, value):
                self._background_pattern = ValidationFunctions.checkPattern(
                    self, 'background_pattern', value)
            background_pattern = property(
                _getbackground_pattern, _setbackground_pattern)
    ...
    def _setvxmin(self, value):
        self._vxmin = ValidationFunctions.checkPositiveNumber(
            self, 'vxmin', value)
    ...
    def _setvxmax(self, value):
        self._vxmax = ValidationFunctions.checkPositiveNumber(
            self, 'vxmax', value)
    ...
    def _setvymin(self, value):
        self._vymin = ValidationFunctions.checkPositiveNumber(
            self, 'vymin', value)
    ...
    def _setvymax(self, value):
        self._vymax = ValidationFunctions.checkPositiveNumber(
            self, 'vymax', value)
    ...
    def _sethidden(self, value):
        self._hidden = ValidationFunctions.checkTrueFalse(
            self, 'hidden', value)
    ...
    def _setstacked(self, value):
        self._stacked = ValidationFunctions.checkTrueFalse(
            self, 'stacked', value)
    ...
    def _setstack_world(self, value):
        self._stack_world = ValidationFunctions.checkList4(
    ...
    def _setbar_hgap(self, value):
        self._bar_hgap = ValidationFunctions.checkPercent(
            self, 'bar_hgap', value)
...
class DSET(object):
    ...
    def __init__(self, parent, color, graph):
        ...
        class Symbol(object):
            ...
            def _settype(self, value):
                self._type = ValidationFunctions.checkSymbol(
                    self, 'type', value)
            type = property(_gettype, _settype)
            ...
            def _setchar_font(self, value):
                self._char_font = ValidationFunctions.checkFont(
            ...
            def _setskip(self, value):
                self._skip = ValidationFunctions.checkPositiveInt(
                    self, 'skip', value)
            skip = property(_getskip, _setskip)
        ...
        class Line(object):
            ...
            def _settype(self, value):
                self._type = ValidationFunctions.checkLineType(
                    self, 'type', value)
            type = property(_gettype, _settype)
        ...
        class Baseline(object):
            ...
            def _settype(self, value):
                self._type = ValidationFunctions.checkBaseLineType(
                    self, 'type', value)
            type = property(_gettype, _settype)
        ...
        class Fill(object):
            ...
            def _settype(self, value):
                self._type = ValidationFunctions.checkFillType(
                    self, 'type', value)
            type = property(_gettype, _settype)
        ...
        class Avalue(object):
            ...
            def _settype(self, value):
                self._type = ValidationFunctions.checkAvalueType(
                    self, 'type', value)
            type = property(_gettype, _settype)
            ...
            def _setprepend(self, value):
                self._prepend = ValidationFunctions.checkString(
                    self, 'prepend', value)
            prepend = property(_getprepend, _setprepend)
                ...
                class Riser(object):
                    ...
                    def __init__(self, parent):
                        ...
                        class Clip(object):
                            ...
                            def _setlength(self, value):
                                self._length = ValidationFunctions.\
                                    checkPositiveNumber(self,
                                                        'length', value)
                            length = property(_getlength, _setlength)
                        self.clip = Clip()
    ...
    def _setdropline(self, value):
        self._dropline = ValidationFunctions.checkOnOff(
            self, 'dropline', value)
...
class STRING(object):
    ...
    def __init__(self, parent, x, y, text, color,
                 char_size, font, rot, just, graph=0):
        self.parent = parent
        self.status = 'on'
        self.loctype = 'view'
        self.color = color
    ...
    def _setjust(self, value):
        self._just = ValidationFunctions.checkJustification(
            self, 'just', value)
...
class LINE(object):
    ...
    def __init__(self, parent, x1, y1, x2, y2, color, lwidth,
                 lstyl, pos, atyp, algth, alyo, graph=0):
        self.parent = parent
        self.status = 'on'
        self.loctype = 'view'
        self.color = color
        ...
        class Arrow(object):
            ...
            def _settype(self, value):
                self._type = ValidationFunctions.checkArrowType(
                    self, 'type', value)
            type = property(_gettype, _settype)
            ...
            def _setposition(self, value):
                self._position = ValidationFunctions.checkArrowPosition(
                    self, 'position', value)
            ...
            def _setlength(self, value):
                self._length = ValidationFunctions.checkPositiveNumber(
                    self, 'length', value)
            length = property(_getlength, _setlength)
            ...
            def _setlayout(self, value):
                self._layout = ValidationFunctions.checkList2(
                    self, 'layout', value)
            layout = property(_getlayout, _setlayout)
...
class BOX_ELLIPSE(object):
    ...
    def __init__(self, parent, x1, y1, x2, y2, color, lwidth,
                 lstyl, fillcolor, fillpattern, graph=0):
        self.parent = parent
        self.status = 'on'
        self.loctype = 'view'
        self.graph = graph
...
class init(object):
    ...
    def __init__(self, xmgrace_args='', pipe_file=None, new_pipe=1,
                 clean_on_exit=True, color=1, font=0,
                 linewidth=1., pattern=1, char_size=1):
        ...
        class Page(object):
            ...
            def _setx(self, value):
                self._x = ValidationFunctions.checkPositiveInt(
                    self, 'x', value)
            x = property(_getx, _setx)
            ...
            def _sety(self, value):
                self._y = ValidationFunctions.checkPositiveInt(
                    self, 'y', value)
            y = property(_gety, _sety)
            ...
            def _setscroll(self, value):
                self._scroll = ValidationFunctions.checkPositiveInt(
                    self, 'scroll', value)
            ...
            def _setinout(self, value):
                self._inout = ValidationFunctions.checkPositiveInt(
                    self, 'inout', value)
            ...
            def _setbackground_fill(self, value):
                self._background_fill = ValidationFunctions.checkOnOff(
                    self, 'background_fill', value)
            background_fill = property(
                _getbackground_fill, _setbackground_fill)
        ...
        class Date(object):
            ...
            def __init__(self):
                ...
                class Wrap(object):
                    ...
                    def _setyear(self, value):
                        self._year = ValidationFunctions.checkPositiveInt(
                            self, 'year', value)
            ...
            def _setreference(self, value):
                self._reference = ValidationFunctions.checkPositiveInt(
        ...
        class Timestamp(object):
            ...
            def _setdefault(self, value):
                self._default = ValidationFunctions.checkString(
                    self, 'default', value)
...
# self.add_color('green4',15)
            ...
            if self.pid == 0:
                try:
                    ...
                    try:
                        ...
                        # exit this forked process but not the parent
                        os._exit(1)
                except:
                    import sys
    ...
    def add_string(self, x, y, text, color=-1,
                   char_size=-1, font=-1, rot=0, just=14):
        if color == -1:
            color = self.color
        if char_size == -1:
    ...
    def add_line(self, x1, y1, x2, y2, color=-1, lwidth=-1,
                 lstyl=-1, position=0, atyp=0, algth=2, alyo=[1., 1.]):
        if color == -1:
            color = self.color
        if lwidth == -1:
            lwidth = self.linewidth
        if lstyl == -1:
            lstyl = self.linestyle
        self.Line.append(
            LINE(
                self,
                x1,
...
# print args
    ...
    def make_parameter(self):
        ...
        ln.append(' page size ' + str(self.page.x) +
                  ', ' + str(self.page.y) + '\n')
        ...
        ln.append(
            ...
            '\n')
        ln.append(' page background fill ' +
                  str(self.page.background_fill) + '\n')
        ln.append(' timestamp ' + self.timestamp.status + '\n')
        ln.append(' timestamp ' + str(self.timestamp.x) +
                  ', ' + str(self.timestamp.y) + '\n')
        ...
        ln.append(' timestamp char size ' +
                  str(self.timestamp.char_size) + '\n')
        ...
        for i in range(self.nstring):
            ...
            if _sproperties in self._all_string:
                continue
        ...
        for i in range(self.nline):
            ...
            ln.append('  line arrow layout ' +
                      str(s.arrow.layout[0]) +
                      ', ' +
                      str(s.arrow.layout[1]) +
                      '\n')
            ln.append('  line def \n')
        ...
        def dset(self, s, l, ln):
            ...
            ln.append(
                ...
                self.col(
                    s.symbol.color) +
                '\n')
            ln.append('s' + ns + ' symbol pattern ' +
                      str(s.symbol.pattern) + '\n')
            ln.append(
                's' +
                ns +
                ' symbol fill color ' +
                self.col(
                    s.symbol.fcolor) +
                '\n')
            ln.append('s' + ns + ' symbol fill pattern ' +
                      str(s.symbol.fpattern) + '\n')
            ln.append('s' + ns + ' symbol linewidth ' +
                      str(s.symbol.linewidth) + '\n')
            ln.append('s' + ns + ' symbol linestyle ' +
                      str(s.symbol.linestyle) + '\n')
            ln.append('s' + ns + ' symbol char ' + str(s.symbol.char) + '\n')
            ln.append('s' + ns + ' symbol char font ' +
                      str(s.symbol.char_font) + '\n')
            ln.append('s' + ns + ' symbol skip ' + str(s.symbol.skip) + '\n')
            ln.append('s' + ns + ' line type ' + str(s.line.type) + '\n')
            ln.append('s' + ns + ' line linestyle ' +
                      str(s.line.linestyle) + '\n')
            ln.append('s' + ns + ' line linewidth ' +
                      str(s.line.linewidth) + '\n')
            ln.append(
                's' +
                ns +
                ' line color ' +
            ...
            ln.append('s' + ns + ' avalue char size ' +
                      str(s.avalue.char_size) + '\n')
            ...
            ln.append('s' + ns + ' errorbar color ' +
                      str(s.errorbar.color) + '\n')
            ln.append('s' + ns + ' errorbar place ' +
                      str(s.errorbar.place) + '\n')
            ln.append('s' + ns + ' errorbar size ' +
                      str(s.errorbar.size) + '\n')
            ln.append('s' + ns + ' errorbar linewidth ' +
                      str(s.errorbar.linewidth) + '\n')
            ln.append('s' + ns + ' errorbar linestyle ' +
                      str(s.errorbar.linestyle) + '\n')
            ln.append('s' + ns + ' errorbar riser linewidth ' +
                      str(s.errorbar.riser.linewidth) + '\n')
            ln.append('s' + ns + ' errorbar riser linestyle ' +
                      str(s.errorbar.riser.linestyle) + '\n')
        ...
        for l in range(self.ngraph):
            ...
            ln.append(' g' + n + ' fixedpoint type ' +
                      str(g.fixedpoint.type) + '\n')
            ln.append(' g' +
                      n +
                      ' fixedpoint xy ' +
                      str(g.fixedpoint.xy[0]) +
                      ', ' +
                      str(g.fixedpoint.xy[1]) +
                      '\n')
            ...
            def axe(self, ln, ax, nm):
                import numpy.ma
                if nm[:3] != 'alt':
                    ln.append('     ' + nm + 'axes scale ' + ax.scale + '\n')
                if nm[:3] != 'alt':
                    ln.append('     ' + nm + 'axes invert ' + ax.invert + '\n')
                ln.append('     ' + nm + 'axis  ' + ax.status + '\n')
                ln.append('     ' + nm + 'axis  type zero ' + ax.zero + '\n')
                if ax.offset == []:
                    ln.append('     ' + nm + 'axis  offset ' +
                              str(ax.xoffset) + ', ' + str(ax.yoffset) + '\n')
                else:
                    ln.append('     ' +
                              nm +
                              'axis  offset ' +
                ...
                ln.append(
                    ...
                    self.col(
                        ax.bar.color) +
                    '\n')
                ln.append('     ' + nm + 'axis  bar linestyle ' +
                          str(ax.bar.linestyle) + '\n')
                ln.append('     ' + nm + 'axis  bar linewidth ' +
                          str(ax.bar.linewidth) + '\n')
                ...
                if isinstance(ax.lbl.place.loc, str):
                    ln.append(
                        '     ' + nm + 'axis  label place %s\n' %
                        (ax.lbl.place.loc))
                else:
                    ln.append('     ' + nm + 'axis  label place spec\n')
                    ln.append(
                        '     ' + nm + 'axis  label place %s, %s\n' %
                        (ax.lbl.place.loc[0], ax.lbl.place.loc[1]))
                ln.append('     ' + nm + 'axis  label char size ' +
                          str(ax.lbl.char_size) + '\n')
                ln.append('     ' + nm + 'axis  label font ' +
                          str(ax.lbl.font) + '\n')
                ln.append(
                    '     ' +
                    nm +
                    ...
                    self.col(
                        ax.lbl.color) +
                    '\n')
                ln.append('     ' + nm + 'axis  label place ' +
                          str(ax.lbl.place.side) + '\n')
                t = ax.tick
                ln.append('     ' + nm + 'axis  tick ' + t.status + '\n')
                ln.append('     ' + nm + 'axis  tick major ' +
                          str(t.inc) + '\n')
                ln.append('     ' + nm + 'axis  tick minor ticks ' +
                          str(t.minor_ticks) + '\n')
                ln.append('     ' + nm + 'axis  tick default ' +
                          str(t.nsub) + '\n')
                ln.append(
                    '     ' +
                    nm +
                ...
                ln.append('     ' + nm + 'axis  tick major size ' +
                          str(t.major.size) + '\n')
                ln.append(
                    '     ' +
                    nm +
                ...
                ln.append('     ' +
                          ...
                          str(t.major.linewidth) +
                          '\n')
                ln.append('     ' +
                          nm +
                          'axis  tick major linestyle ' +
                          str(t.major.linestyle) +
                          '\n')
                ln.append(
                    '     ' +
                    nm +
                    ...
                    t.major.grid +
                    '\n')
                ln.append('     ' + nm + 'axis  tick minor size ' +
                          str(t.minor.size) + '\n')
                ln.append(
                    '     ' +
                    nm +
                ...
                ln.append('     ' +
                          ...
                          str(t.minor.linewidth) +
                          '\n')
                ln.append('     ' +
                          nm +
                          'axis  tick minor linestyle ' +
                          str(t.minor.linestyle) +
                          '\n')
                ln.append(
                    '     ' +
                    nm +
                ...
                ln.append(
                    ...
                    t.label.status +
                    '\n')
                ln.append('     ' + nm + 'axis  ticklabel prec ' +
                          str(t.label.prec) + '\n')
                ln.append(
                    '     ' +
                    nm +
                ...
                ln.append(
                    ...
                    t.label.prepend +
                    '"\n')
                ln.append('     ' + nm + 'axis  ticklabel angle ' +
                          str(t.label.angle) + '\n')
                ln.append('     ' + nm + 'axis  ticklabel skip ' +
                          str(t.label.skip) + '\n')
                ln.append('     ' +
                          nm +
                          ...
                          str(t.label.stagger) +
                          '\n')
                ln.append('     ' + nm + 'axis  ticklabel place ' +
                          str(t.label.place) + '\n')
                if t.label.offset != 'auto':
                    ...
                    ln.append(
                        '     ' + nm + 'axis  ticklabel offset 0.00 ,0.01\n')
                if t.label.start == 'auto':
                    ln.append(
                        '     ' + nm + 'axis  ticklabel start type auto\n')
                    ln.append(
                        '     ' + nm + 'axis  ticklabel start 0.000000\n')
                else:
                    ln.append(
                        '     ' + nm + 'axis  ticklabel start type spe\n')
                    ln.append('     ' +
                              nm +
                ...
                if t.label.stop == 'auto':
                    ln.append(
                        '     ' + nm + 'axis  ticklabel stop type auto\n')
                ...
                ln.append('     ' +
                          ...
                          str(t.label.char_size) +
                          '\n')
                ln.append('     ' + nm + 'axis  ticklabel font ' +
                          str(t.label.font) + '\n')
                ln.append(
                    '     ' +
                    nm +
...
# t.spec.values=['90S','60S','30S','Eq','30N','60N','90N']
                    t.spec.values = {-1.: '90S', -0.866: '60S', -0.5: '30S',
                                     0.: 'Eq', 0.5: '30N',
                                     0.866: '60N', 1.: '90N'}
                if numpy.ma.isMA(t.spec.loc):
                    t.spec.loc = list(t.spec.loc)
                if t.type == 'spec' or isinstance(t.spec.loc, type({})) \
                   or isinstance(t.spec.values, type({})) or \
                   (t.spec.loc != [] and t.spec.values != []):
                    if isinstance(t.spec.values, type({})):
                        mydic = t.spec.values
                        t.spec.loc = []
                        t.spec.values = []
            ...
            ln.append('   legend box linewidth ' +
                      str(leg.box.linewidth) + '\n')
            ln.append('   legend box linestyle ' +
                      str(leg.box.linestyle) + '\n')
            ln.append(
                '   legend box fill color ' +
                self.col(
                    leg.box.fcolor) +
                '\n')
            ln.append('   legend box fill pattern ' +
                      str(leg.box.fpattern) + '\n')
            ...
            ln.append(
                ...
                self.col(
                    frm.background_color) +
                '\n')
            ln.append('   frame background pattern ' +
                      str(frm.background_pattern) + '\n')
...
# print "swaping G",G0,'S',S0,'and G',G1,'.S',S1
    ...
    def copy(self, S0, S1, G0=0, G1=0):
        """copy sets definitions and possibly set if presents.
        Destination must exist"""
        self.Graph[G1].Set[S1] = self.Graph[G0].Set[S0]
        self.__call__(
            "COPY G" +
    ...
    def _setlink_page(self, value):
        self._link_page = ValidationFunctions.checkOnOff(
            self, 'link_page', value)
    ...
    def _setsymbol_size(self, value):
        self._symbol_size = ValidationFunctions.checkPositiveInt(
    ...
    def _setbackground_color(self, value):
        self._background_color = ValidationFunctions.checkPositiveInt(
            self, 'background_color', value)
